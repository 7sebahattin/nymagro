...
(function() {
  ...
  /* Ürün/kalem KDV oranını güvenle çöz: %0 GEÇERLİ bir orandır, "değer yok"
     ...
     yeni eklenen satırlar için önce alis_kdv_orani'ye bakılır; mevcut bir
     faturadan yüklenen kalemlerde (mevcutKalemler) bu alan hiç yok, o zaman
     kalemin kendi kayıtlı kdv_orani'sine düşülür. İlk tanımlı (undefined/
     null/boş olmayan) değer kullanılır, hiçbiri yoksa varsayılana düşülür. */
