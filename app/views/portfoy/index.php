...
<style>
  ...
  .pf-card{background:#fff;border:1px solid #e9d5ff;border-radius:14px;box-shadow:0 12px 28px rgba(76,29,149,.06);overflow:hidden}.pf-head{padding:16px 18px;background:linear-gradient(135deg,#4c1d95,#8b5cf6);color:#fff}.pf-head h2{font-size:18px;margin:0;font-weight:900}.pf-head p{margin:3px 0 0;color:#ddd6fe;font-size:12px}.pf-form{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;padding:16px}.pf-field{display:grid;gap:5px}.pf-field.wide{grid-column:span 2}.pf-field label{font-size:12px;font-weight:800;color:#475569}.pf-field input,.pf-field select,.pf-field textarea{border:1px solid #ddd6fe;border-radius:9px;padding:9px 10px;font-size:13px;outline:none}.pf-field textarea{resize:vertical;min-height:42px}.pf-field input:focus,.pf-field select:focus,.pf-field textarea:focus{border-color:#8b5cf6;box-shadow:0 0 0 3px rgba(139,92,246,.13)}.pf-actions{display:flex;align-items:end}.pf-btn{border:0;border-radius:9px;padding:10px 14px;font-size:13px;font-weight:900;text-decoration:none;display:inline-flex;gap:7px;align-items:center;justify-content:center}.pf-btn.primary{background:linear-gradient(135deg,#7c3aed,#c026d3);color:#fff}.pf-btn.danger{background:#fee2e2;color:#b91c1c}.pf-table-wrap{overflow-x:auto}.pf-table{width:100%;border-collapse:collapse;min-width:820px}.pf-table th{background:#f8fafc;color:#64748b;font-size:12px;text-align:left;padding:11px 14px;border-bottom:1px solid #e2e8f0}.pf-table td{padding:12px 14px;border-bottom:1px solid #f1f5f9;font-size:13px;color:#334155}.pf-table b{color:#1e1b4b}.pf-status{display:inline-flex;border-radius:999px;padding:4px 9px;background:#ede9fe;color:#6d28d9;font-size:11px;font-weight:900}.pf-empty{padding:34px;text-align:center;color:#64748b}.pf-empty i{display:block;font-size:28px;color:#8b5cf6;margin-bottom:10px}@media(max-width:1000px){.pf-form{grid-template-columns:1fr}.pf-field.wide{grid-column:auto}.pf-btn{width:100%}}
</style>
<div class="pf-page">
