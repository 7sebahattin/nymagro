...
/* ════════════════════════════════════
    ...
    .belge-tipi-btn:hover, .belge-tipi-btn.open { border-color: #94a3b8; }
    .belge-tipi-btn i { font-size: 10px; color: #94a3b8; transition: transform .2s; }
    ...
    .belge-chk-item:hover { background: #f8fafc; }
    .belge-chk-item.indent { padding-left: 30px; }
    .belge-chk-item input[type="checkbox"] { width: 14px; height: 14px; accent-color: #1e293b; cursor: pointer; flex-shrink: 0; }
    ...
    .period-item.active { font-weight: 700; color: #1e293b; background: #f1f5f9; }
    ...
    .search-txt {
      padding: 6px 12px 6px 30px; border: 1px solid #cbd5e1; border-radius: 6px;
    ...
    .sort-ic { font-size: 10px; color: #475569; }
    ...
    .prod-thumb { width: 34px; height: 34px; background: #e2e8f0; border-radius: 5px; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 14px; }
    .td-num { text-align: right; }
    .detail-user-line { margin-top: 10px; font-size: 12px; color: #64748b; }
    .detail-user-line strong { color: #374151; }
    ...
    .pag-btn { width: 30px; height: 30px; border: 1px solid #e2e8f0; border-radius: 6px; background: #fff; font-size: 12px; color: #475569; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background .12s, border-color .12s; }
    ...
    .toast-msg.success { background: #fff; border-left: 4px solid #22c55e; }
    .toast-msg.error   { background: #fff; border-left: 4px solid #ef4444; }
    .toast-msg.info    { background: #fff; border-left: 4px solid #3b82f6; }
    ...
    .ym-modal {
      background: #fff; border-radius: 6px; width: 520px; max-width: 96vw;
    ...
    .ym-info { background: #fefce8; border: 1px solid #fde68a; border-radius: 5px; padding: 10px 14px; font-size: 13px; color: #713f12; line-height: 1.55; }
    .ym-info strong { color: #92400e; }
    ...
    .ym-hint { font-size: 11.5px; color: #64748b; margin-top: 2px; }
    .ym-row2 { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
    .ym-footer { padding: 12px 20px; border-top: 1px solid #f1f5f9; display: flex; justify-content: flex-end; gap: 8px; flex-shrink: 0; }
...
<!-- ── Action Buttons (screenshot'taki 4 buton) ── -->
    ...
    <!-- Info Box -->
    <div style="background-color: #fcf8e3; border: 1px solid #faebcc; color: #8a6d3b; padding: 15px 20px; border-radius: 4px; font-size: 13px; line-height: 1.6; margin-top: 10px;">
