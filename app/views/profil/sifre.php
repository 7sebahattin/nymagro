...
<style>
  ...
  .pass-card{background:#fff;border:1px solid #e9d5ff;border-radius:16px;box-shadow:0 12px 34px rgba(76,29,149,.08);overflow:hidden}
  .pass-head{padding:24px;background:linear-gradient(135deg,#4c1d95,#7c3aed 58%,#c026d3);color:#fff}
  .pass-head h3{font-size:20px;font-weight:900;margin:0}
  .pass-head p{font-size:13px;color:#ddd6fe;margin:5px 0 0}
  ...
  .pass-input{width:100%;border:1.5px solid #e9d5ff;border-radius:10px;padding:12px;font:inherit;font-size:13.5px;color:#1e1b4b;outline:none;background:#fff;transition:border-color .15s,box-shadow .15s}
  .pass-input:focus{border-color:#a855f7;box-shadow:0 0 0 4px rgba(168,85,247,.12)}
  ...
  .pass-btn.primary{background:linear-gradient(135deg,#7c3aed,#c026d3);color:#fff;box-shadow:0 8px 20px rgba(124,58,237,.25)}
  .pass-btn.ghost{background:#fff;color:#4c1d95;border:1.5px solid #e9d5ff}
