...
<style>
  ...
  .project-card{background:#fff;border:1px solid #cfe1cd;border-radius:14px;box-shadow:0 12px 28px rgba(8,69,38,.06);overflow:hidden}.project-head{padding:16px 18px;background:linear-gradient(135deg,#084526,#1e8c55);color:#fff}.project-head h2{font-size:18px;margin:0;font-weight:900}.project-head p{margin:3px 0 0;color:#cfe1cd;font-size:12px}.project-form{display:grid;grid-template-columns:1.2fr 2fr 180px 120px;gap:12px;padding:16px}.project-field{display:grid;gap:5px}.project-field label{font-size:12px;font-weight:800;color:#475569}.project-field input,.project-field select,.project-field textarea{border:1px solid #cfe1cd;border-radius:9px;padding:9px 10px;font-size:13px;outline:none}.project-field textarea{resize:vertical;min-height:42px}.project-field input:focus,.project-field select:focus,.project-field textarea:focus{border-color:#1e8c55;box-shadow:0 0 0 3px rgba(30,140,85,.13)}.project-actions{display:flex;align-items:end}.project-btn{border:0;border-radius:9px;padding:10px 14px;font-size:13px;font-weight:900;text-decoration:none;display:inline-flex;gap:7px;align-items:center;justify-content:center}.project-btn.primary{background:linear-gradient(135deg,#0d623a,#d97a0c);color:#fff}.project-btn.danger{background:#fee2e2;color:#b91c1c}.project-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:12px;padding:16px}.project-item{border:1px solid #ecf5eb;border-radius:12px;padding:14px;background:#f5faf4}.project-item h3{font-size:15px;color:#1e1b4b;margin:0 0 8px;font-weight:900}.project-item p{font-size:13px;color:#64748b;min-height:34px}.status{display:inline-flex;border-radius:999px;padding:4px 9px;background:#e6f2e5;color:#0d623a;font-size:11px;font-weight:900}.project-empty{padding:34px;text-align:center;color:#64748b}.project-empty i{display:block;font-size:28px;color:#1e8c55;margin-bottom:10px}@media(max-width:900px){.project-form{grid-template-columns:1fr}.project-btn{width:100%}}
</style>
