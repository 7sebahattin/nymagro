<style>
.panel{background:var(--card-bg);border:1px solid var(--border);border-radius:6px;overflow:hidden;max-width:1100px}.panel h5{margin:0;background:#2c3e6b;color:#fff;padding:11px 14px;font-size:14px}.body{padding:16px}.grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}label{font-size:12px;font-weight:700;color:var(--text2)}input,select,textarea{width:100%;border:1px solid var(--border2);border-radius:4px;padding:7px;font-size:13px}.full{grid-column:1/-1}.btn{border:0;border-radius:4px;padding:8px 14px;font-weight:700;color:#fff;background:#5cb85c;text-decoration:none}.btn.gray{background:#64748b}@media(max-width:900px){.grid{grid-template-columns:1fr 1fr}}@media(max-width:600px){.grid{grid-template-columns:1fr}}
</style>
