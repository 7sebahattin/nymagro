...
.gef-table th{background:var(--surface-2);color:var(--text);font-size:11.5px;text-align:left;padding:9px;white-space:nowrap}.gef-table td{font-size:12.5px;padding:8px 9px;border-bottom:1px solid var(--border);vertical-align:middle}
