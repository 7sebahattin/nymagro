...
.market-card{position:relative;border-radius:18px;overflow:hidden;min-height:200px;background:linear-gradient(135deg,#073820,#0d623a);color:#fff;padding:3.1rem 1.5rem 1.5rem;display:flex;flex-direction:column;justify-content:flex-start;transition:.25s}
