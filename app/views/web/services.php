...
.svc-card{background:#fff;border-radius:18px;border:1px solid rgba(124,58,237,.1);padding:1.8rem;height:100%;transition:.25s;position:relative;overflow:hidden}
.svc-card::before{content:'';position:absolute;top:0;right:0;width:120px;height:120px;background:radial-gradient(circle,rgba(124,58,237,.08),transparent 70%);border-radius:50%;transform:translate(40%,-40%)}
.svc-card:hover{transform:translateY(-6px);box-shadow:0 22px 50px -22px rgba(124,58,237,.4);border-color:rgba(124,58,237,.25)}
.svc-icon{width:60px;height:60px;border-radius:16px;background:var(--grad);color:#fff;font-size:1.4rem;display:flex;align-items:center;justify-content:center;margin-bottom:1.2rem;box-shadow:0 14px 30px -12px rgba(124,58,237,.55)}
