...
.region-card{position:relative;border-radius:22px;overflow:hidden;min-height:280px;color:#fff;padding:2rem;display:flex;flex-direction:column;justify-content:flex-end;background:linear-gradient(135deg,#3b1c5e,#7c3aed);transition:.25s}
.region-card:hover{transform:translateY(-4px);color:#fff;box-shadow:0 30px 60px -25px rgba(124,58,237,.6)}
...
.region-card p{color:#e6dffa;margin:0 0 1rem;font-size:.94rem}
