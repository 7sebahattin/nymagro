...
<style>
  ...
  .asset-card{background:#fff;border:1px solid #e9d5ff;border-radius:14px;box-shadow:0 12px 28px rgba(76,29,149,.06);overflow:hidden}.asset-head{padding:16px 18px;background:linear-gradient(135deg,#4c1d95,#8b5cf6);color:#fff}.asset-head h2{font-size:18px;margin:0;font-weight:900}.asset-head p{margin:3px 0 0;color:#ddd6fe;font-size:12px}.asset-form{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;padding:16px}.asset-field{display:grid;gap:5px}.asset-field.wide{grid-column:span 2}.asset-field label{font-size:12px;font-weight:800;color:#475569}.asset-field input,.asset-field textarea{border:1px solid #ddd6fe;border-radius:9px;padding:9px 10px;font-size:13px;outline:none}.asset-field textarea{resize:vertical;min-height:42px}.asset-field input:focus,.asset-field textarea:focus{border-color:#8b5cf6;box-shadow:0 0 0 3px rgba(139,92,246,.13)}.asset-btn{border:0;border-radius:9px;padding:10px 14px;font-size:13px;font-weight:900;text-decoration:none;display:inline-flex;gap:7px;align-items:center;justify-content:center}.asset-btn.primary{background:linear-gradient(135deg,#7c3aed,#c026d3);color:#fff}.asset-btn.danger{background:#fee2e2;color:#b91c1c}.asset-actions{display:flex;align-items:end}.asset-table-wrap{overflow-x:auto}.asset-table{width:100%;border-collapse:collapse;min-width:760px}.asset-table th{background:#f8fafc;color:#64748b;font-size:12px;text-align:left;padding:11px 14px;border-bottom:1px solid #e2e8f0}.asset-table td{padding:12px 14px;border-bottom:1px solid #f1f5f9;font-size:13px;color:#334155}.asset-table b{color:#1e1b4b}.asset-empty{padding:34px;text-align:center;color:#64748b}.asset-empty i{display:block;font-size:28px;color:#8b5cf6;margin-bottom:10px}@media(max-width:900px){.asset-form{grid-template-columns:1fr}.asset-field.wide{grid-column:auto}.asset-btn{width:100%}}
</style>
