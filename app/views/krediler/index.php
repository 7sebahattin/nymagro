...
<style>
  ...
  .nm-form{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;padding:16px}.nm-field{display:grid;gap:5px}.nm-field.wide{grid-column:span 2}.nm-field label{font-size:12px;font-weight:800;color:#475569}.nm-field input,.nm-field select,.nm-field textarea{width:100%;border:1px solid #cfe1cd;border-radius:9px;padding:9px 10px;font-size:13px;color:#1e1b4b;outline:none}.nm-field textarea{min-height:42px;resize:vertical}.nm-field input:focus,.nm-field select:focus,.nm-field textarea:focus{border-color:#1e8c55;box-shadow:0 0 0 3px rgba(30,140,85,.13)}.nm-actions{display:flex;align-items:end}.nm-btn{border:0;border-radius:9px;padding:10px 14px;font-size:13px;font-weight:900;text-decoration:none;display:inline-flex;gap:7px;align-items:center;justify-content:center}.nm-btn.primary{background:linear-gradient(135deg,#0d623a,#d97a0c);color:#fff}.nm-btn.danger{background:#fee2e2;color:#b91c1c}
  .nm-table-wrap{overflow-x:auto}.nm-table{width:100%;border-collapse:collapse;min-width:820px}.nm-table th{background:#f8fafc;color:#64748b;font-size:12px;text-align:left;padding:11px 14px;border-bottom:1px solid #e2e8f0}.nm-table td{padding:12px 14px;border-bottom:1px solid #f1f5f9;font-size:13px;color:#334155}.nm-table b{color:#1e1b4b}.nm-empty{padding:34px;text-align:center;color:#64748b}.nm-empty i{display:block;font-size:28px;color:#1e8c55;margin-bottom:10px}
